 ...
 *                                                                           *
 * Author: Arash Partow - 2002 - Modified by Tia Watts for SSU CS 375 2021   *
...
public:
   ...
   //inline void set_pixel(const unsigned int x, const unsigned int y,  // modified 10/26/2020 Tia Watts
   inline void set_pixel(const double x, const double y,
                         ...
                         const unsigned char blue)
   {
	...
	if (y < 0 || y > height_-1)
      ...
      //const unsigned int y_offset = y * row_increment_;
      //const unsigned int x_offset = x * bytes_per_pixel_;
      const unsigned int y_offset = round(y) * row_increment_;
      const unsigned int x_offset = round(x) * bytes_per_pixel_;
   ...
   inline void set_pixel(const double x, const double y, const RGB& colour)
   {
...
private:
   ...
   void create_bitmap()
   {
 //     errorflag_ = false; // modified 10/15/2020 Tia Watts and Trent Rhodes-Ousley
   ...
   bool errorflag_ = false; // modified 10/15/2020 Tia Watts and Trent Rhodes-Ousley
   unsigned int width_ = 0;
   unsigned int height_ = 0;
   unsigned int row_increment_ = 0;
   unsigned int bytes_per_pixel_ = 0;
   channel_mode channel_mode_ = rgb_mode;
